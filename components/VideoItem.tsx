...
export const VideoItemSkeleton = React.memo(() => (
...
export const VideoItem = React.memo(
    ({ item, searchQuery, noEllipsis, onPress, onLongPress, onInfoPress, onMenuPress }: VideoItemProps) => {
        ...
        const title = React.useMemo(
            ...
            [item.displayName, searchQuery, colors.primary, noEllipsis],
        );
